...
```ts
type CheckRepeatedTuple<T extends unknown[], Previous extends unknown[] = []> = T extends [infer A, ...infer Rest]
? A extends Previous[number] 
  ? true 
  : CheckRepeatedTuple<Rest, [...Previous, A]>
: false
```
