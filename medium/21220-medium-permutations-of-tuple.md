...
```ts
type PermutationsOfTuple<T extends unknown[], Pre extends unknown[] = []> = T extends [infer A, ...infer Rest]
? [A, ...PermutationsOfTuple<[...Pre, ...Rest]>] | (Rest extends [] ? never : PermutationsOfTuple<Rest, [...Pre, A]>)
: []
```
