...
? (RealEqual<N, A> extends true ? true : Include<B, N>)
: false

type Unique<T, Result extends unknown[] = []> = T extends [infer A, ...infer B] 
? Include<Result, A> extends false ? Unique<B, [...Result, A]> : Unique<B, Result>
: Result
```